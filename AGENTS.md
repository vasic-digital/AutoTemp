# AGENTS.md -- digital.vasic.autotemp
...
Benchmark-driven temperature auto-tuning orchestration.

## Primary consumer

HelixAgent (`dev.helix.agent`). See the consuming-side Phase-A spec
at `docs/superpowers/specs/2026-04-21-elder-plinius-phaseA-go-autotemp.md` in the HelixAgent repository.
